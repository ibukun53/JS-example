...
document.querySelector('.content-btn').style.cssText = 'border-radius: 4px; padding: 2%; margin: 10% 33% 5%;; background:  #805500; align-items: center; filter: contrast(150%)';
